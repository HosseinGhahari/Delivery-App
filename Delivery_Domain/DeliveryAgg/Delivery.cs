...
namespace Delivery_Domain.DeliveryAgg
{
    ...
    public class Delivery
    {
        ...
        public Delivery(bool isPaid, int destinationId, DateTime date, string userid, double? optionalPrice)
        {
            IsPaid = isPaid;
        ...
        public void Edit(bool isPaid, int destinationId, DateTime date , double? optionalPrice)
        {
            IsPaid = isPaid;
            DestinationId = destinationId;
            DeliveryTime = date;
